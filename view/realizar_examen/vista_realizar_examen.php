...
<script src="../js/realizar_examen.js?rev=<?php echo time();?>"></script>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Mantenimiento realizar examenes</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="modal fade" id="modal_editar_contra"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <script type="text/javascript">
  listar_realizar_examen_serverside();
